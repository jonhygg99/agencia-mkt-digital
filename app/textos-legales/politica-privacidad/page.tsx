  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          En {NOMBRE_EMPRESA} tratamos la información que nos facilitan las
          personas interesadas con los siguientes fines:
        </p>
        <ul className="list-disc pl-6 space-y-2">
          <li>Gestionar el envío de la información que nos soliciten.</li>
          <li>
            Desarrollar acciones comerciales y el mantenimiento de la relación
            comercial.
          </li>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            El consentimiento del interesado para el envío de información
            comercial.
          </li>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            Durante el tiempo necesario para cumplir con las obligaciones
            legales.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 space-y-2">
          ...
          <li>
            Supresión de sus datos cuando, entre otros motivos, ya no sean
            necesarios.
          </li>
        ...
        <p className="mt-4">
          Los interesados podrán ejercer sus derechos enviando un correo
          electrónico a {EMAIL_EMPRESA}.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          {NOMBRE_EMPRESA} ha adoptado todas las medidas técnicas y
      ...
      <section>
        ...
        <p className="mb-4">
          {NOMBRE_EMPRESA} se reserva el derecho de modificar la presente
